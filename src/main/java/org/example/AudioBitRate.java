...
@Component
public class AudioBitRate implements Module{
    @Override
    ...
    public String getDescription() {
        return "Возвращает скорость передачи битов mp3-трека";
    }
    ...
    public void invoke(Path path) {
        try {
            ...
            String b = (String) format.get("bit_rate");
            System.out.printf("Cкорость передачи битов: %s", b);
            process.destroy();
        } catch (IOException e) {
